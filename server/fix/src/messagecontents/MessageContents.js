import prebuiltMap from './../../prebuild/built/MessageContents.prebuilt.json' with { type: "json" };

export class MessageContents {
  constructor() {
    this.cacheMap = new Map();
    Object.entries(prebuiltMap).forEach((pair) => this.cacheMap.set(pair[0], pair[1]));
  }
